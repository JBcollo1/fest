  ...
  const safariTypes = [
    {
      ...
      color: isDarkMode ? "bg-amber-950/80" : "bg-amber-500",
    ...
    },
    {
      ...
      color: isDarkMode ? "bg-emerald-950/80" : "bg-emerald-600",
    ...
    },
    {
      ...
      color: isDarkMode ? "bg-indigo-950/80" : "bg-indigo-600",
    ...
    },
    {
      ...
      color: isDarkMode ? "bg-rose-950/80" : "bg-rose-600",
    ...
    },
    {
      ...
      color: isDarkMode ? "bg-sky-950/80" : "bg-sky-600",
    ...
    },
    {
      ...
      color: isDarkMode ? "bg-violet-950/80" : "bg-violet-600",
    ...
    },
    {
      ...
      color: isDarkMode ? "bg-orange-950/80" : "bg-orange-600",
    ...
    },
    {
      ...
      color: isDarkMode ? "bg-lime-950/80" : "bg-lime-600",
      backgroundImage: "url('https://example.com/conservation.jpg')"
    }
  ];

  return (
    <section className={`py-20 ${isDarkMode ? 'bg-gradient-to-b from-slate-950 to-black' : 'bg-gradient-to-b from-slate-900 to-slate-800'} text-white`} id="safari">
        ...
        <div className="max-w-7xl mx-auto">
              ...
              <AnimatedSection key={safari.name} delay={100 + index * 50}>
                <div className={`relative group rounded-xl overflow-hidden min-h-[400px] transition-all duration-300 hover:shadow-2xl ${safari.color}`}>
                  ...
                  <div className="relative z-20 h-full flex flex-col justify-end p-6">
                    <div className={`${isDarkMode ? 'text-primary' : 'text-white'}`}>
                      {safari.icon}
                    </div>
                    <h3 className="text-xl font-bold mb-2">{safari.name}</h3>
                    <p className={`${isDarkMode ? 'text-white/80' : 'text-white/90'} mb-4 text-sm`}>{safari.description}</p>
                    <ul className="space-y-1.5">
                      {safari.features.map((feature, i) => (
                        <li key={i} className={`text-xs font-medium ${isDarkMode ? 'text-white/70' : 'text-white/80'} flex items-center`}>
          ...
          <AnimatedSection delay={400}>
            <div className="mt-16 text-center">
              <Link 
                to="/safaris" 
                className={`inline-flex items-center ${isDarkMode ? 'bg-amber-700 hover:bg-amber-800' : 'bg-amber-500 hover:bg-amber-600'} text-black font-medium rounded-full px-8 py-3 transition-colors`}
              >
